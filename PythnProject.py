...
submit = Image.open("IMAGES\SUBMIT.png")
submit_photo1 = ImageTk.PhotoImage(submit)

# Resizing the btn

resized = submit.resize((140, 80), Image.LANCZOS)
submit = ImageTk.PhotoImage(file="IMAGES\SUBMIT.png")
...
bridge1 = ImageTk.PhotoImage(
    file="IMAGES/nature/bridge1.jpeg")
...
bridge3 = ImageTk.PhotoImage(
    file="IMAGES/nature/bridge3.jpg")
...
bridge4 = ImageTk.PhotoImage(
    file="IMAGES/nature/bridge4.jpeg")
...
road1 = ImageTk.PhotoImage(
    file="IMAGES/nature/road1.jpeg")
road_pic1 = ImageTk.PhotoImage(resized)

#   Including the road images

road2 = Image.open(
    "IMAGES/nature/road2.jpeg")
...
road4 = ImageTk.PhotoImage(
    file="IMAGES/nature/road4.jpg")
road_pic4 = ImageTk.PhotoImage(resized)

#   Including the road images

road5 = Image.open(
    "IMAGES/nature/road5.jpg")
...
cat1 = ImageTk.PhotoImage(
    file="IMAGES/animal/cat1.jpeg")
cat_pic1 = ImageTk.PhotoImage(resized)

#   Including the images

cat2 = Image.open(
    "IMAGES/animal/cat2.jpeg")
...
cat2 = ImageTk.PhotoImage(
    file="IMAGES/animal/cat2.jpeg")
cat_pic2 = ImageTk.PhotoImage(resized)

#   Including the images

cat3 = Image.open(
    "IMAGES/animal/cat3.jpg")
...
calf1 = ImageTk.PhotoImage(
    file="IMAGES/animal/calf1.jpeg")
calf_pic1 = ImageTk.PhotoImage(resized)

#   Including the animals images

calf2 = Image.open(
    "IMAGES/animal/calf2.jpeg")
...
dog2 = ImageTk.PhotoImage(
    file="IMAGES/animal/dog2.jpeg")
dog_pic2 = ImageTk.PhotoImage(resized)

#   Including the animals images

dog3 = Image.open(
    "IMAGES/animal/dog3.jpeg")
